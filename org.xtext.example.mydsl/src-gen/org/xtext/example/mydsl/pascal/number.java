 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.number#getInteger <em>Integer</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.number#getReal <em>Real</em>}</li>
 * </ul>
 * </p>
 *
...
public interface number extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getnumber_Integer()
   * @model
   * @generated
   */
  String getInteger();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.number#getInteger <em>Integer</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setReal(String)
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getnumber_Real()
   * @model
   * @generated
   */
  String getReal();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.number#getReal <em>Real</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
