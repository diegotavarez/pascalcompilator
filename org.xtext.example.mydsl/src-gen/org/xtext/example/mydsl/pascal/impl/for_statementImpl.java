 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.for_statementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.for_statementImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.for_statementImpl#getExpression2 <em>Expression2</em>}</li>
 ...
 * @generated
 */
public class for_statementImpl extends repetitive_statementImpl implements for_statement
{
  /**
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.FOR_STATEMENT__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetExpression1(expression newExpression1, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.FOR_STATEMENT__EXPRESSION1, oldExpression1, newExpression1);
  ...
  public void setExpression1(expression newExpression1)
  {
    if (newExpression1 != expression1)
    {
      ...
      if (expression1 != null)
        msgs = ((InternalEObject)expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.FOR_STATEMENT__EXPRESSION1, null, msgs);
      if (newExpression1 != null)
        msgs = ((InternalEObject)newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.FOR_STATEMENT__EXPRESSION1, null, msgs);
      msgs = basicSetExpression1(newExpression1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.FOR_STATEMENT__EXPRESSION1, newExpression1, newExpression1));
  }
  ...
  public NotificationChain basicSetExpression2(expression newExpression2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.FOR_STATEMENT__EXPRESSION2, oldExpression2, newExpression2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression2(expression newExpression2)
  {
    if (newExpression2 != expression2)
    {
      NotificationChain msgs = null;
      if (expression2 != null)
        msgs = ((InternalEObject)expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.FOR_STATEMENT__EXPRESSION2, null, msgs);
      if (newExpression2 != null)
        msgs = ((InternalEObject)newExpression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.FOR_STATEMENT__EXPRESSION2, null, msgs);
      msgs = basicSetExpression2(newExpression2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.FOR_STATEMENT__EXPRESSION2, newExpression2, newExpression2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.FOR_STATEMENT__EXPRESSION1:
        return basicSetExpression1(null, msgs);
      case PascalPackage.FOR_STATEMENT__EXPRESSION2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PascalPackage.FOR_STATEMENT__NAME:
        return getName();
      case PascalPackage.FOR_STATEMENT__EXPRESSION1:
