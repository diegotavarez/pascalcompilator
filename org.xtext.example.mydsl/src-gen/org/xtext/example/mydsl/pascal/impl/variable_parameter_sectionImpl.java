 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.variable_parameter_sectionImpl#getIdentifierList <em>Identifier List</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.variable_parameter_sectionImpl#getParameterType <em>Parameter Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class variable_parameter_sectionImpl extends MinimalEObjectImpl.Container implements variable_parameter_section
{
  ...
  public NotificationChain basicSetIdentifierList(identifier_list newIdentifierList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, oldIdentifierList, newIdentifierList);
  ...
  public void setIdentifierList(identifier_list newIdentifierList)
  {
    if (newIdentifierList != identifierList)
    {
      ...
      if (identifierList != null)
        msgs = ((InternalEObject)identifierList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, null, msgs);
      if (newIdentifierList != null)
        msgs = ((InternalEObject)newIdentifierList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifierList(newIdentifierList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, newIdentifierList, newIdentifierList));
  }
  ...
  public NotificationChain basicSetParameterType(parameter_type newParameterType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, oldParameterType, newParameterType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameterType(parameter_type newParameterType)
  {
    if (newParameterType != parameterType)
    {
      ...
      if (parameterType != null)
        msgs = ((InternalEObject)parameterType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, null, msgs);
      if (newParameterType != null)
        msgs = ((InternalEObject)newParameterType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, null, msgs);
      msgs = basicSetParameterType(newParameterType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, newParameterType, newParameterType));
  }
